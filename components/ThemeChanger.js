...
const DarkModeToggle = () => {
  ...
  return (
    <AnimatePresence exitBeforeEnter initial={false}>
      ...
      >
        {darkModeActive ? (
          <Image src="/assets/light_mode_white_24dp.svg" width="20" height="20" alt="theme-dark" />
        ) : (
          <Image src="/assets/dark_mode_black_24dp.svg" width="20" height="20" alt="theme-dark" />
        )}
      </motion.button>
    </AnimatePresence>
  );
